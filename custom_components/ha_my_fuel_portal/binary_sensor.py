"""Binary sensor platform for ha_my_fuel_portal."""
...
ENTITY_DESCRIPTIONS = (
    BinarySensorEntityDescription(
        ...
        name="MyFuelPortal Binary Sensor",
...
class MyFuelPortalBinarySensor(MyFuelPortalEntity, BinarySensorEntity):
    """ha_my_fuel_portal binary_sensor class."""
